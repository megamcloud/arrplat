...
<script lang="ts">
  ...
  @Component({
    components: { Card, PhoneLogin, Logo },
    layout: 'front'
  })
  export default class Index extends Vue {
    ...
    public handleChangeLoginType() {
      this.loginType = this.loginType === 'login' ? 'weChart' : 'login'
    }
  }
</script>
