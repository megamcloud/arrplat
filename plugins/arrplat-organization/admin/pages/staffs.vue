<template>
  <ArrPanel title="成员管理" border>
    ...
    <div class="member-table">
      ...
      <StaffTable @onRefreshTable="refreshTable" :allStaffs="allStaffs" />
    </div>

    <StaffEditor :staff="staff" :isEdit="isEdit" :dialogVisible="dialogVisible" @onChange="handleDialogChanged"/>
  </ArrPanel>
</template>
<style lang="scss">
  .member-table {
